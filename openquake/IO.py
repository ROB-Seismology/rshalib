...
def parse_disaggregation(xml_filespec):
    ...
    mag_bin_edges = disagg_matrices.get('magBinEdges').split(', ')
    dist_bin_edges = disagg_matrices.get('distBinEdges').split(', ')
    lon_bin_edges = disagg_matrices.get('lonBinEdges').split(', ')
    lat_bin_edges = disagg_matrices.get('latBinEdges').split(', ')
    eps_bin_edges = disagg_matrices.get('epsBinEdges').split(', ')
